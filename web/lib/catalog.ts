...
export const CATALOG: CatalogItem[] = [
  ...
  { id: "drumstick-leaves", name: "Drumstick leaves", defaultUnit: "bunch", defaultRate: 3.99, emoji: "🌿" },
  { id: "vallarai", name: "Vallarai", defaultUnit: "bunch", defaultRate: 3.99, emoji: "🌿" },
  { id: "ponnangani-keerai", name: "Ponnangani keerai", defaultUnit: "bunch", defaultRate: 3.99, emoji: "🌿" },
  { id: "agathi-keerai", name: "Agathi keerai", defaultUnit: "bunch", defaultRate: 3.99, emoji: "🌿" },
  { id: "kankun", name: "Kankun", defaultUnit: "bunch", defaultRate: 3.99, emoji: "🥬" },
  { id: "curry-leaves", name: "Curry leaves", defaultUnit: "bunch", defaultRate: 0.99, emoji: "🍃" },
  { id: "greens", name: "Greens", defaultUnit: "bunch", emoji: "🌿", image: "/items/greens.jpg" },

  // Single-leaf items.
  { id: "banana-leaf", name: "Banana leaf", defaultUnit: "single", defaultRate: 1.0, emoji: "🍌" },
  { id: "neem-leaves", name: "Neem leaves", defaultUnit: "single", defaultRate: 1.0, emoji: "🌿" },
  { id: "betal-leaves", name: "Betal leaves", defaultUnit: "single", defaultRate: 1.0, emoji: "🌿" },
  { id: "vilva-leaves", name: "Vilva leaves", defaultUnit: "single", defaultRate: 3.0, emoji: "🍀" },
  { id: "mango-leaves", name: "Mango leaves", defaultUnit: "single", defaultRate: 1.0, emoji: "🌿" },
  ...
  { id: "jackfruit", name: "Jackfruit", defaultUnit: "kg", defaultRate: 9.99, emoji: "🌳" },
  { id: "bonji", name: "Bonji", defaultUnit: "kg", defaultRate: 8.99, emoji: "🥒" },
  { id: "amberlla", name: "Amberlla", defaultUnit: "kg", defaultRate: 8.99, emoji: "🥒" },
  { id: "banana-flower", name: "Banana flower", defaultUnit: "kg", defaultRate: 8.99, emoji: "🌺" },
  { id: "white-pavakai", name: "White pavakai", defaultUnit: "kg", defaultRate: 8.99, emoji: "🥒" },
  { id: "banana-stem", name: "Banana stem", defaultUnit: "kg", defaultRate: 8.99, emoji: "🌱" },
  { id: "red-banana-small", name: "Red banana (small)", defaultUnit: "kg", defaultRate: 9.99, emoji: "🍌" },
  { id: "wood-apple", name: "Wood apple", defaultUnit: "kg", defaultRate: 9.99, emoji: "🌰" },
  { id: "karunai-kilangu", name: "Karunai kilangu", defaultUnit: "kg", defaultRate: 8.99, emoji: "🍠" },
  ...
  { id: "guava", name: "Guava", defaultUnit: "single", defaultRate: 0.99, emoji: "🍐" },
  ...
  { id: "sev-elani", name: "Sev elani", defaultUnit: "single", defaultRate: 4.99, emoji: "🥔" },
  { id: "bombay-onion", name: "Bombay onion", defaultUnit: "single", defaultRate: 2.99, emoji: "🧅" },
  { id: "sundaka", name: "Sundaka", defaultUnit: "single", defaultRate: 4.99, emoji: "🫐" },
